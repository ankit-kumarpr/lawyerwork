  ...
  const handleUpdateCustomer = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://lawyerwork.onrender.com/lawapi/common/updateuser/${selectedCustomer.userId}`,
        editedCustomer,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      toast.error(
        "Update failed: " + (error.response?.data?.message || "Network Error")
      );
    } finally {
      setUpdatingId(null);
    }
            ...
            >
              {editMode ? (
                ...
                <>
                  ...
                  <DetailItem
                    label="Purpose"
                    value={selectedCustomer.purpose || "Not specified"}
                  />
                  <DetailItem
          ...
          {editMode ? (
            <>
              ...
              <Button
                ...
                color="primary"
                startIcon={
                  updatingId ? <CircularProgress size={20} /> : <SaveIcon />
                }
                disabled={updatingId}
              >
